function z = receptiveGaborField_azymetric2(x, y, A, x0, y0, sigma_x, sigma_y, sigma_x_old, sigma_y_old, theta,k,phi,B,B_new)
% Function:      receptiveField_azymetric_sigma
%                Creates an asymmetrically rotated and expanded two-dimensional Gabbor receptive field with variable standard deviations.
...
%
    ...
    z_positive =A * gaborFunction(x_prime, y_prime, sigma_x, sigma_y, k, phi,B_new);
