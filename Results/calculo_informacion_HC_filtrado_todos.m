...
for ii = 1:length(percentages)
    ...
    cutoff_frequency = 200; % Cutoff frequency for the filter
...
plot(tiempo,potencial{3, 5}, 'b-', 'DisplayName', 'Señal Original');
hold on;
plot(tiempo,datos_filtrados, 'r-', 'DisplayName', 'Señal Filtrada');
hold off;
